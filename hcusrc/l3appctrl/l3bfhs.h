...
enum FSM_STATE_L3BFHS
{
	...
	FSM_STATE_L3BFHS_OPR_CFG,  	//配置状态
	FSM_STATE_L3BFHS_OPR_GO,  	//人工命令启动状态
	FSM_STATE_L3BFHS_OOS_SCAN,  //进料组合态
	FSM_STATE_L3BFHS_OOS_TTT,  	//出料流程态
	FSM_STATE_L3BFHS_OOS_TGU,  	//放弃物料态
...
//大量编辑性错误，不得不采用这种方式
#ifndef HCU_SYSCFG_BFHS_SNR_WS_NBR_MAX
	#define HCU_SYSCFG_BFHS_SNR_WS_NBR_MAX 16  //下位机总共有16个秤盘
#endif
...
#define HCU_L3BFHS_SENSOR_WS_STATUS_CFG_CMPL 		13  	//配置完成
#define HCU_L3BFHS_SENSOR_WS_STATUS_START_REQ 		14  	//启动开始
#define HCU_L3BFHS_SENSOR_WS_STATUS_STOP_REQ 		15  	//停止开始
#define HCU_L3BFHS_SENSOR_WS_STATUS_STOP_CMPL 		16  	//停止完成
...
#define HCU_L3BFHS_SENSOR_WS_STATUS_VALID_TO_TTT 	34		//秤盘有料待出料
#define HCU_L3BFHS_SENSOR_WS_STATUS_VALID_TTT_START 35		//秤盘有料开始出
#define HCU_L3BFHS_SENSOR_WS_STATUS_VALID_TO_TGU 	36		//秤盘有料待抛弃
#define HCU_L3BFHS_SENSOR_WS_STATUS_VALID_TGU_START 37		//秤盘有料开始出抛
...
typedef struct gTaskL3bfhsContext
{
	...
	UINT8												comAlgParPriority[HCU_SYSCFG_BFHS_SNR_WS_NBR_MAX];
	...
	L3BfhsSensorWsInfo_t	sensorWs[HCU_SYSCFG_BFHS_SNR_WS_NBR_MAX];
	...
	UINT8 	wsBitmap[HCU_SYSCFG_BFHS_SNR_WS_NBR_MAX];  //组合出的秤盘标示
...
extern OPSTAT fsm_l3bfhs_canitf_cmd_resp(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);
extern OPSTAT fsm_l3bfhs_uicomm_config_req(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);
extern OPSTAT fsm_l3bfhs_canitf_config_resp(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);
extern OPSTAT fsm_l3bfhs_canitf_sys_start_resp(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);
extern OPSTAT fsm_l3bfhs_canitf_sys_stop_resp(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);

//API组合部分
extern OPSTAT fsm_l3bfhs_canitf_ws_comb_out_fb(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);
extern OPSTAT fsm_l3bfhs_canitf_ws_give_up_fb(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);
