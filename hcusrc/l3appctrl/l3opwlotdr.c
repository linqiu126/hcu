...
*/
HcuFsmStateItem_t HcuFsmL3opwlotdr[] =
{
    ...
    {MSG_ID_COM_RESTART,						FSM_STATE_COMMON,            				fsm_l3opwlotdr_restart},
	{MSG_ID_COM_TIME_OUT,       				FSM_STATE_COMMON,          					fsm_l3opwlotdr_time_out},
...
OPSTAT fsm_l3opwlotdr_init(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	...
	//Global Variables
	zHcuSysStaPm.taskRunErrCnt[TASK_ID_L3OPWLOTDR] = 0;

	//启动周期性定时器
	ret = hcu_timer_start(TASK_ID_L3OPWLOTDR, TIMER_ID_1S_L3OPWLOTDR_PERIOD_READ, \
			zHcuSysEngPar.timer.array[TIMER_ID_1S_L3OPWLOTDR_PERIOD_READ].dur, TIMER_TYPE_PERIOD, TIMER_RESOLUTION_1S);
	if (ret == FAILURE){
...
OPSTAT fsm_l3opwlotdr_time_out(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	...
	if (zHcuSysStaPm.taskRunErrCnt[TASK_ID_L3OPWLOTDR] > HCU_RUN_ERROR_LEVEL_2_MAJOR){
		//减少重复RESTART的概率
		zHcuSysStaPm.taskRunErrCnt[TASK_ID_L3OPWLOTDR] = zHcuSysStaPm.taskRunErrCnt[TASK_ID_L3OPWLOTDR] - HCU_RUN_ERROR_LEVEL_2_MAJOR;
