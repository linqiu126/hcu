...
FsmStateItem_t FsmL3aqycg20[] =
{
    ...
    {MSG_ID_COM_INIT,       					FSM_STATE_L3AQYCG20_INITIED,            		fsm_l3aqycg20_init},
    {MSG_ID_COM_RESTART,						FSM_STATE_L3AQYCG20_INITIED,            		fsm_l3aqycg20_restart},
    {MSG_ID_COM_INIT_FEEDBACK,					FSM_STATE_L3AQYCG20_INITIED,            		fsm_com_do_nothing},
...
OPSTAT fsm_l3aqycg20_time_out(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	...
	if (zHcuRunErrCnt[TASK_ID_L3AQYCG20] > HCU_RUN_ERROR_LEVEL_2_MAJOR){
		...
		if (ret == FAILURE){
			zHcuRunErrCnt[TASK_ID_L3AQYCG20]++;
			HcuErrorPrint("L3AQYCG20: Send message error, TASK [%s] to TASK[%s]!\n", zHcuTaskNameList[TASK_ID_L3AQYCG20], zHcuTaskNameList[TASK_ID_L3AQYCG20]);
			return FAILURE;
		}
	}
