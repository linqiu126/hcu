 ...
 *  全局常量命名规则
 *
 *  - 全局常量使用全大写方式，并以HCU_开头
 *  - 全局常量目前重要包括HCU_SYSVM_, HCU_SYSCFG_, HCU_SYSENG, HCU_SYSMSG_, 分别代表VM层／CONFIG/ENGPAR/COMMSG层面的全局常量
 *  - 模块中的全局常量以HCU_(TASKNAME)_命名，方便区分和寻找该全局常量是由哪个模块命名的，同时也防止重名冲突，方便未来采用Refactor进行维护
 *  - 没有意外，全局常量不得少于10个字符串
 *
 *************************************************************************************************************************/
...
enum HCU_TIMER_ID_ALL
{
	...
	TIMER_ID_1S_HSMMP_PERIOD_CURL_PICTURE,
	...
	TIMER_ID_1S_L3BFSC_SYS_CALI_WAIT_FB,
	...
	TIMER_ID_1S_L3BFDF_STOP_WAIT_FB,
	...
	TIMER_ID_1S_L3BFHS_STOP_WAIT_FB,
	TIMER_ID_1S_L3BFHS_RESUME_WAIT_FB,
	TIMER_ID_1S_L3BFHS_CAL_ZERO_WAIT_FB,
	TIMER_ID_1S_L3BFHS_CAL_FULL_WAIT_FB,
	...
	TIMER_ID_1S_L3AQYCG20_START_MIN_REPORT,//add by shanchun for pol report
	TIMER_ID_1S_L3AQYCG20_STOP_MIN_REPORT,
	TIMER_ID_1S_L3AQYCG20_START_HOUR_REPORT,
