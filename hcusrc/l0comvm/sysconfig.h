...
//基于G2/树莓派的AQYC
	...
	//面对服务器，定义本地名字
	#define HCU_SYSCFG_CLOUD_SVR_ADDR_HTTP_LOCAL 			"http://127.0.0.1/test.php"
	#define HCU_SYSCFG_CLOUD_HCU_NAME "HCU_G2100DAYC_TMP01"     //DEVICE NAME
	#define HCU_SYSCFG_CLOUD_ZHBMN_NAME 					"AQHJ0QP0100001"//"ABCDEFG_AQYC12"
...
*/
	...
	//批量生产标志信息，固件升级标识，以及物理烧录信息等
	#define HCU_SYSCFG_HW_PRODUCT_CAT_TYPE 		(2100) //十进制
	#define HCU_SYSCFG_HBB_FW_UPGRADE_SET HCU_SYSCFG_HBB_FW_UPGRADE_YES_PATCH
	#define HCU_SYSCFG_HBB_PHY_BOOT_CFG_FILE	"/var/hcu/cfg/hcuboot.cfg"
...
//波峰双线分选组合称流水线上位机
	...
	//分选组合算法缺省控制参数
	#define HCU_SYSCFG_ALGO_SPACE_CTRL_RATIO_DEFAULT	0.05
	#define HCU_SYSCFG_UPLIMIT_VS_GRP_DISTR_RATIO_MAX	0.5

	//性能测试与评估全局申明
	#define HCU_SYSCFG_L3BFDF_PMAS_ENABLE	1
	#define HCU_SYSCFG_L3BFDF_PMAS_DISABLE	2
	#define HCU_SYSCFG_L3BFDF_PMAS_SET       HCU_SYSCFG_L3BFDF_PMAS_DISABLE
