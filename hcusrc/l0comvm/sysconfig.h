...
#define HCU_WORK_MODE_PROCESS_NULL 		0
...
#define HCU_WORK_MODE_PROCESS_OTHER 	5
#define HCU_WORK_MODE_PROCESS_INVALID 	0xFF
...
//与后台的接口格式
#define HCU_CLOUDVELA_BH_INTERFACE_STANDARD_NULL 			0
#define HCU_CLOUDVELA_BH_INTERFACE_STANDARD_XML 			1
#define HCU_CLOUDVELA_BH_INTERFACE_STANDARD_ZHB 			2  //中环保
#define HCU_CLOUDVELA_BH_INTERFACE_STANDARD_HUITP_L2FRAME 	3
#define HCU_CLOUDVELA_BH_INTERFACE_STANDARD_HUITP_XML 		4
#define HCU_CLOUDVELA_BH_INTERFACE_STANDARD_HUITP_JASON 	5
#define HCU_CLOUDVELA_BH_INTERFACE_STANDARD_INVALID 		0xFF

//模块是否激活
#define HCU_TASK_PNP_NULL 		0
#define HCU_TASK_PNP_ON 		1
#define HCU_TASK_PNP_OFF 		2
#define HCU_TASK_PNP_INIT 		3
#define HCU_TASK_PNP_INVALID 	0xFF

//通信媒介选择
#define HCU_CLOUDVELA_BH_PHY_LINK_NULL 0
#define HCU_CLOUDVELA_BH_PHY_LINK_ETH  1
#define HCU_CLOUDVELA_BH_PHY_LINK_WIFI 2
#define HCU_CLOUDVELA_BH_PHY_LINK_3G4G 3
#define HCU_CLOUDVELA_BH_PHY_LINK_USBNET 4
#define HCU_CLOUDVELA_BH_PHY_LINK_OTHER 5
#define HCU_CLOUDVELA_BH_PHY_LINK_INVALID 0xFF

//定义硬件是否进入批量生产阶段，从而决定硬件标签读入的方式
#define HCU_HARDWARE_MASSIVE_PRODUTION_YES 1
#define HCU_HARDWARE_MASSIVE_PRODUTION_NO 2

//定义是否允许初始化TRACE的MODULE和MSGID表单
#define HCU_TRACE_DB_SET_INIT_BY_VM_STATIC_TABLE_YES 1
#define HCU_TRACE_DB_SET_INIT_BY_VM_STATIC_TABLE_NO 2

//定义固件是否支持升级
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_NONE 0
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_NO 1
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_YES_STABLE 2
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_YES_TRAIL 3
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_YES_PATCH 4
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_YES_INVALID 0xFF

//定义软件升级方式
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_METHOD_NULL 0
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_METHOD_UART_DIRECT 1
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_METHOD_UART_GPRS 2
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_METHOD_CANITF 3
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_METHOD_UDISK 4
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_METHOD_SD_CARD 5
#define HCU_HARDWARE_BURN_ID_FW_UPGRADE_METHOD_USBNET 6
...
//DEBUG开关，缺省打开
#define HCU_TRACE_DEBUG_ALL_OFF 0 //全关
#define HCU_TRACE_DEBUG_INF_ON 1  //全开
#define HCU_TRACE_DEBUG_NOR_ON 2  //普通级
#define HCU_TRACE_DEBUG_IPT_ON 4  //重要级
#define HCU_TRACE_DEBUG_CRT_ON 8  //关键级
#define HCU_TRACE_DEBUG_FAT_ON 16 //致命级

//TRACE开关，缺省打开
#define HCU_TRACE_MSG_MODE_OFF 0 //全关
#define HCU_TRACE_MSG_MODE_INVALID 0xFF //无效
#define HCU_TRACE_MSG_MODE_ALL 1 //放开所有的TRACE模块和消息，该模式将忽略模块和消息的设置
#define HCU_TRACE_MSG_MODE_ALL_BUT_TIME_OUT 2  //除了所有的TIME_OUT消息
#define HCU_TRACE_MSG_MODE_ALL_BUT_HEART_BEAT 3 //除了所有的HEART_BEAT消息
#define HCU_TRACE_MSG_MODE_ALL_BUT_TIME_OUT_AND_HEART_BEAT 4  //除了所有的TIME_OUT消息
#define HCU_TRACE_MSG_MODE_MOUDLE_TO_ALLOW 10  //只通过模块号过滤消息
#define HCU_TRACE_MSG_MODE_MOUDLE_TO_RESTRICT 11  //只通过模块号过滤消息
#define HCU_TRACE_MSG_MODE_MOUDLE_FROM_ALLOW 12  //只通过模块号过滤消息
#define HCU_TRACE_MSG_MODE_MOUDLE_FROM_RESTRICT 13  //只通过模块号过滤消息
#define HCU_TRACE_MSG_MODE_MOUDLE_DOUBLE_ALLOW 14  //只通过模块号过滤消息
#define HCU_TRACE_MSG_MODE_MOUDLE_DOUBLE_RESTRICT 15  //只通过模块号过滤消息
#define HCU_TRACE_MSG_MODE_MSGID_ALLOW 20  //只通过模块号过滤消息
#define HCU_TRACE_MSG_MODE_MSGID_RESTRICT 21  //只通过模块号过滤消息
#define HCU_TRACE_MSG_MODE_COMBINE_TO_ALLOW 30  //通过模块和消息枚举
#define HCU_TRACE_MSG_MODE_COMBINE_TO_RESTRICT 31  //通过模块和消息枚举
#define HCU_TRACE_MSG_MODE_COMBINE_FROM_ALLOW 32  //通过模块和消息枚举
#define HCU_TRACE_MSG_MODE_COMBINE_FROM_RESTRICT 33  //通过模块和消息枚举
#define HCU_TRACE_MSG_MODE_COMBINE_DOUBLE_ALLOW 34  //通过模块和消息枚举
#define HCU_TRACE_MSG_MODE_COMBINE_DOUBLE_RESTRICT 35  //通过模块和消息枚举
...
//老旧的AQYC项目
	...
	#define HCU_COMM_HW_BOARD_3G4G HCU_TASK_PNP_ON
	#define HCU_COMM_HW_BOARD_GPS HCU_TASK_PNP_ON
	#define HCU_COMM_HW_BOARD_LCD HCU_TASK_PNP_OFF
	#define HCU_COMM_HW_BOARD_LED HCU_TASK_PNP_OFF
	#define HCU_COMM_HW_BOARD_ZEEGBE HCU_TASK_PNP_OFF
	#define HCU_COMM_HW_BOARD_FLASH HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_MODBUS HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SPSVIRGO HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_AVORION HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_CLOUDVELA HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_I2CBUSLIBRA HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SPIBUSARIES HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_NBIOTCJ188 HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_NBIOTQG376 HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SPS485 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SPS232 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_MICROPHONE HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_CAMERA HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_BLE HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_GPIO HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_I2C HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SPI HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_PWM HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_ADC HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SWITCH HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_RELAY HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_MOTOR HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_EMC HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_PM25 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_TEMP HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_HUMID HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_WINDDIR HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_WINDSPD HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_NOISE HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_HSMMP HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_AIRPRS HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_CO1 HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_LIGHTSTR HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_ALCOHOL HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_HCHO HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_TOXICGAS HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_PM25SHARP HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_IWM HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_IHM HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SENSOR_IGM HCU_TASK_PNP_OFF
	...
	#define HCU_SENSOR_PRESENT_PWM_LED2PIN HCU_SENSOR_PRESENT_YES
...
//打开所有模块，为了测试性能
	...
	#define HCU_COMM_HW_BOARD_3G4G HCU_TASK_PNP_ON
	#define HCU_COMM_HW_BOARD_GPS HCU_TASK_PNP_ON
	#define HCU_COMM_HW_BOARD_LCD HCU_TASK_PNP_ON
	#define HCU_COMM_HW_BOARD_LED HCU_TASK_PNP_ON
	#define HCU_COMM_HW_BOARD_ZEEGBE HCU_TASK_PNP_OFF
	#define HCU_COMM_HW_BOARD_FLASH HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_MODBUS HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SPSVIRGO HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_AVORION HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_CLOUDVELA HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_I2CBUSLIBRA HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SPIBUSARIES HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_NBIOTCJ188 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_NBIOTQG376 HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_SPS485 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SPS232 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_MICROPHONE HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_CAMERA HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_BLE HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_GPIO HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_I2C HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SPI HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_PWM HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_ADC HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SWITCH HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_RELAY HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_MOTOR HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_EMC HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_PM25 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_TEMP HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_HUMID HCU_TASK_PNP_ON
	...
	#define HCU_COMM_FRONT_SENSOR_NOISE HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_HSMMP HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_AIRPRS HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_CO1 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_LIGHTSTR HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_ALCOHOL HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_HCHO HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_TOXICGAS HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_PM25SHARP HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_IWM HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_IHM HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_IGM HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_IPM HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_CANITF HCU_TASK_PNP_OFF
...
//CHUNXU低功耗抄表
	...
	#define HCU_COMM_FRONT_SENSOR_IGM HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SENSOR_IPM HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_CANITF 0
...
//CHUNXU中等功耗抄表
	...
	#define HCU_COMM_FRONT_SPIBUSARIES HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_NBIOTCJ188 HCU_TASK_PNP_OFF
	#define HCU_COMM_FRONT_NBIOTQG376 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SPS485 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_SPS232 HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_MICROPHONE HCU_TASK_PNP_ON
	#define HCU_COMM_FRONT_CAMERA HCU_TASK_PNP_ON
...
//波峰组合秤上位机
	...
	#define HCU_COMM_BACK_HAWL_CON HCU_CLOUDVELA_BH_PHY_LINK_ETH
//	#define HCU_COMM_HW_BOARD_ETHERNET HCU_TASK_PNP_ON
//	#define HCU_COMM_HW_BOARD_USBNET HCU_TASK_PNP_OFF
//	#define HCU_COMM_HW_BOARD_WIFI HCU_TASK_PNP_ON
//	#define HCU_COMM_HW_BOARD_3G4G HCU_TASK_PNP_ON
//	#define HCU_COMM_HW_BOARD_GPS HCU_TASK_PNP_ON
//	#define HCU_COMM_HW_BOARD_LCD HCU_TASK_PNP_OFF
...
//	#define HCU_COMM_FRONT_MODBUS HCU_TASK_PNP_ON
//	#define HCU_COMM_FRONT_SPSVIRGO HCU_TASK_PNP_ON
//	#define HCU_COMM_FRONT_AVORION HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_CLOUDVELA HCU_TASK_PNP_ON
//	#define HCU_COMM_FRONT_I2CBUSLIBRA HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SPIBUSARIES HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_NBIOTCJ188 HCU_TASK_PNP_OFF
...
//	#define HCU_COMM_FRONT_SPS232 HCU_TASK_PNP_ON
//	#define HCU_COMM_FRONT_MICROPHONE HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_CAMERA HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_BLE HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_GPIO HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_I2C HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SPI HCU_TASK_PNP_OFF
...
//	#define HCU_COMM_FRONT_MOTOR HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_EMC HCU_TASK_PNP_ON
//	#define HCU_COMM_FRONT_SENSOR_PM25 HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_TEMP HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_HUMID HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_WINDDIR HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_WINDSPD HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_NOISE HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_HSMMP HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_AIRPRS HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_CO1 HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_LIGHTSTR HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_ALCOHOL HCU_TASK_PNP_OFF
...
//	#define HCU_COMM_FRONT_SENSOR_IGM HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_SENSOR_IPM HCU_TASK_PNP_OFF
//	#define HCU_COMM_FRONT_CANITF HCU_TASK_PNP_ON
