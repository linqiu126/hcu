...
//波峰组合秤上位机
	...
	//传感器配置参数
	#define HCU_SYSCFG_SNR_DATA_SAVE_TO_LOCAL_DB_SET 		HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES
	#define HCU_SYSCFG_SNR_DATA_SAVE_TO_MEMDISK_SET 		HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES
	#define HCU_SYSCFG_SNR_DATA_SAVE_TO_FLASH_DISK_SET 		HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES
	#define HCU_SYSCFG_SNR_DATA_SAVE_DURATION_MIN_IN_DAYS 	60
	#define HCU_SYSCFG_SNR_DATA_SAVE_DURATION_IN_DAYS 		90
