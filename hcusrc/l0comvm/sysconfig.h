...
//波峰双线分选组合称流水线上位机
	...
	#define HCU_SYSCFG_BFDF_EQU_FLOW_NBR_MAX	1  	//流水线数量
	#define HCU_SYSCFG_BFDF_SNC_BOARD_NBR_MAX	1  	//IO板子数量，每一条线的数量，而不是总数量 DEFAULT=4
	#define HCU_SYSCFG_BFDF_HOPPER_IN_ONE_BOARD	8	//每个IO单板中的料斗数量：FIXED CAN NOT CHANGE!
	#define HCU_SYSCFG_BFDF_HOPPER_NBR_MAX		(HCU_SYSCFG_BFDF_SNC_BOARD_NBR_MAX*HCU_SYSCFG_BFDF_HOPPER_IN_ONE_BOARD)	//料斗数量   DEFAULT=32
