...
/*
	...
	#define HCU_SYSCFG_CLOUD_SVR_PORT_DEFAULT				HCU_SYSCFG_CLOUD_BH_ITF_PORT_XML
	//#define HCU_SYSCFG_CLOUD_SVR_DEFAULT_ITF_STD_SET 		HCU_SYSCFG_CLOUD_BH_ITF_STD_XML
...
*/
	...
	//打印和TRACE开关
	#define HCU_SYSCFG_TRACE_DEBUG_SET HCU_SYSCFG_TRACE_DEBUG_IPT_ON //利用以上标示位，确定TRACE的级别
	#define HCU_SYSCFG_TRACE_MSG_SET HCU_SYSCFG_TRACE_MSG_MODE_ALL_BUT_TIME_OUT_AND_HEART_BEAT
