...
extern OPSTAT hcu_restful_HUIREST_ACTIONID_VISION_worm_clasify_single(StrRestMsgIn_HUIREST_ACTIONID_VISION_worm_clasify_single_t *in, StrRestMsgIn_HUIREST_ACTIONID_VISION_worm_clasify_single_fb_t *out);
extern OPSTAT hcu_restful_HUIREST_ACTIONID_AIWGT_test1(StrRestMsgIn_HUIREST_ACTIONID_AIWGT_test1_t *in, StrRestMsgOut_HUIREST_ACTIONID_general_t *out);
