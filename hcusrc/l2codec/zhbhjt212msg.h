...
#define ZHBHJT_IE_uni__QNRTN_PSWD_ERROR 3

//EXEQTN
#define ZHBHJT_IE_uni__EXETRN_EXE_SUCCESS 1
#define ZHBHJT_IE_uni__EXETRN_EXE_FAILURE 2
#define ZHBHJT_IE_uni__EXETRN_EXE_NO_DATA 100
