...
extern OPSTAT func_cloudvela_huitpxml_msg_time_sync_req_received_handle(StrMsg_HUITP_MSGID_uni_time_sync_req_t *rcv);
extern OPSTAT func_cloudvela_huitpxml_msg_time_sync_confirm_received_handle(StrMsg_HUITP_MSGID_uni_time_sync_confirm_t *rcv);
