	...
	function (chart) {
		if (!chart.renderer.forExport) {
		    setInterval(
		        ...
		        //json start
		        $.getJSON('/l3ui/web/index.php?r=hcuemcdatainfo/getlasthcuemcdatainfo', function(result){
		        	dataval = result.data.emcvalue;
		        	//alert(result.data.emcvalue);
		        	point.update(dataval);
		        });
		        /*dataval = data['emcvalue'];
