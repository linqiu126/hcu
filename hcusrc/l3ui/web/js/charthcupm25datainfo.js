	...
	function (chart) {
		if (!chart.renderer.forExport) {
		    setInterval(
		        ...
		        //json start
		        $.getJSON('/yii2basic/web/index.php?r=hcupm25datainfo/getlasthcupm25datainfo', function(result){
...
function charthcupm25datainfosingle() {
