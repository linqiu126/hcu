function charthcuhumiddatainfo() {
	...
	function (chart) {
		if (!chart.renderer.forExport) {
		    setInterval(
		        ...
		        //json start
		        $.getJSON('/yii2basic/web/index.php?r=hcuhumiddatainfo/getlasthcuhumiddatainfo', function(result){
...
function charthcuhumiddatainfosingle() {
