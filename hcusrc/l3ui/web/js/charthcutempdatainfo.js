	...
	function (chart) {
		if (!chart.renderer.forExport) {
		    setInterval(
		        ...
		        //json start
		        $.getJSON('/yii2basic/web/index.php?r=hcutempdatainfo/getlasthcutempdatainfo', function(result){
		        	dataval = result.data.tempvalue;
		        	//alert(result.data.tempvalue);
		        	point.update(dataval);
		        });
		        /*dataval = data['tempvalue'];
...
function charthcutempdatainfosingle() {
