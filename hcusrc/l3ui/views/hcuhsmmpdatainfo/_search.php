...
/* @var $model app\models\HcuhsmmpdatainfoSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="hcuhsmmpdatainfo-search">
    ...
    <?= $form->field($model, 'hsmmpfdir') ?>

    <?= $form->field($model, 'hsmmpfname') ?>

    <?php // echo $form->field($model, 'hsmmplink') ?>
