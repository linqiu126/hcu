...
extern OPSTAT dbi_HcuIpmQg376DataInfo_save(sensor_ipm_qg376_data_element_t *ipmData);
extern OPSTAT dbi_HcuIpmQg376DataInfo_inqury_1st_record(char *addr, sensor_ipm_qg376_data_element_t *ipmData);
