...
#define HCU_SYSCFG_BFHS_DB_COLUMN_NUM_MAX 28
...
extern OPSTAT dbi_HcuBfhs_staticCaliData_save(StrMsgIe_WeightSensorBfhsCalibrationFullRespParamaters_t *input);
extern OPSTAT dbi_HcuBfhs_dynCaliData_save(UINT32 dynCaliCoeff);
