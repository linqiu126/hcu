...
*///
	...
	snd.windspd.dataFormat = CLOUD_SENSOR_DATA_FOMAT_FLOAT_WITH_NF1;
...
*///
	...
	snd.temp.dataFormat = CLOUD_SENSOR_DATA_FOMAT_FLOAT_WITH_NF1;
...
OPSTAT func_modbus_pm25_msg_unpack(SerialModbusMsgBuf_t *buf, msg_struct_pm25_modbus_data_read_t *rcv, msg_struct_modbus_pm25_data_report_t *snd)
{
	...
	case L3PO_pm25_data_req:
		...
		else if (zHcuSysEngPar.hwBurnId.hwType == HCU_SYSCFG_INVENT_HWTYPE_PDTYPE_G2_AQYC_RASP_2004)//阿尔森4-20MA/RS485
		{
