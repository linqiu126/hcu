...
//TEST CASE FUNCTIONS
gTaskL3hateTestCaseSet_t zHcuTc_HATE_TCID_BFSC_STARTUP_IND_COMING = {
	HATE_TCID_BFSC_STARTUP_IND_COMING,
	{{HATE_TCE_CTRL_START, NULL},
	{HATE_TCE_CTRL_SND, func_l3hate_bfsc_tc_HATE_TCID_BFSC_STARTUP_IND_COMING_snd_s1_startup_ind},
	{HATE_TCE_CTRL_CMPL, NULL}}
};

gTaskL3hateTestCaseSet_t zHcuTc_HATE_TCID_BFSC_WS_NEW_EVENT_COMING = {
	HATE_TCID_BFSC_WS_NEW_EVENT_COMING,
	{{HATE_TCE_CTRL_START, NULL},
	{HATE_TCE_CTRL_SND, func_l3hate_bfsc_tc_HATE_TCID_BFSC_WS_NEW_EVENT_COMING_snd_s1_ws_new_event},
	{HATE_TCE_CTRL_CMPL, NULL}}
};

gTaskL3hateTestCaseSet_t zHcuTc_HATE_TCID_BFSC_CONFIG_ALL_NODES = {
	HATE_TCID_BFSC_CONFIG_ALL_NODES,
	{{HATE_TCE_CTRL_START, NULL},
	{HATE_TCE_CTRL_SND, func_l3hate_bfsc_tc_HATE_TCID_BFSC_CONFIG_ALL_NODES_snd1_commu_set_config},
	{HATE_TCE_CTRL_RCV, func_l3hate_bfsc_tc_HATE_TCID_BFSC_CONFIG_ALL_NODES_rcv1_can_config_to_node},
	{HATE_TCE_CTRL_SND, func_l3hate_bfsc_tc_HATE_TCID_BFSC_CONFIG_ALL_NODES_snd2_can_config_resp_ok},
	{HATE_TCE_CTRL_RCV, func_l3hate_bfsc_tc_HATE_TCID_BFSC_CONFIG_ALL_NODES_rcv2_db_config_set},
	{HATE_TCE_CTRL_CMPL, NULL}}
};
