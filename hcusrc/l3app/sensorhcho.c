...
OPSTAT func_hcho_time_out_read_data_from_ze08ch2o(void)
{
	...
	//存入数据库
	if ((HCU_SYSCFG_SNR_DATA_SAVE_TO_LOCAL_DB_SET == HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES) && (zHcuSps232HchoZe08ch2o >= HCU_SENSOR_HCHO_VALUE_MIN) && (zHcuSps232HchoZe08ch2o <= HCU_SENSOR_HCHO_VALUE_MAX))
	{
