...
HcuFsmStateItem_t HcuFsmSysswm[] =
{
    ...
    {MSG_ID_COM_RESTART,		FSM_STATE_IDLE,            				fsm_sysswm_restart},
    {MSG_ID_COM_INIT_FEEDBACK,	FSM_STATE_IDLE,            				fsm_com_do_nothing},

	//Task level initialization
    {MSG_ID_COM_INIT,       	FSM_STATE_SYSSWM_INITIED,            	fsm_sysswm_init},
    {MSG_ID_COM_RESTART,		FSM_STATE_SYSSWM_INITIED,            	fsm_sysswm_restart},
    {MSG_ID_COM_INIT_FEEDBACK,	FSM_STATE_SYSSWM_INITIED,            	fsm_com_do_nothing},

    //Task level initialization
    {MSG_ID_COM_RESTART,        FSM_STATE_SYSSWM_ACTIVED,            	fsm_sysswm_restart},
    {MSG_ID_COM_INIT_FEEDBACK,	FSM_STATE_SYSSWM_ACTIVED,            	fsm_com_do_nothing},
	{MSG_ID_COM_HEART_BEAT,     FSM_STATE_SYSSWM_ACTIVED,       		fsm_com_heart_beat_rcv},
	{MSG_ID_COM_HEART_BEAT_FB,  FSM_STATE_SYSSWM_ACTIVED,       		fsm_com_do_nothing},
	{MSG_ID_COM_TIME_OUT,       FSM_STATE_SYSSWM_ACTIVED,          		fsm_sysswm_time_out},
