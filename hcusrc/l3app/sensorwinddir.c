...
HcuFsmStateItem_t HcuFsmWinddir[] =
{
	...
	{MSG_ID_L3AQYC_EXG_CTRL_REQ,				FSM_STATE_WINDDIR_ACTIVED,      	fsm_winddir_l3aqyc_exg_ctrl_req},
	{MSG_ID_ZHBL3MOD_EXG_CTRL_REQ,				FSM_STATE_WINDDIR_ACTIVED,      	fsm_winddir_zhbl3mod_exg_ctrl_req},
...
OPSTAT fsm_winddir_task_entry(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	...
	FsmSetState(TASK_ID_WINDDIR, FSM_STATE_IDLE);
	return SUCCESS;
}
...
OPSTAT fsm_winddir_init(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	...
	FsmSetState(TASK_ID_WINDDIR, FSM_STATE_WINDDIR_INITED);
	HCU_DEBUG_PRINT_FAT("WINDDIR: Enter FSM_STATE_WINDDIR_INITED status, everything goes well!\n");
...
*/
	if ((FsmGetState(TASK_ID_CLOUDVELA) == FSM_STATE_CLOUDVELA_ONLINE) || (FsmGetState(TASK_ID_CLOUDVELA) == FSM_STATE_CLOUDVELA_OFFLINE))
	{
		...
		snd.winddir.nTimes = rcv.winddir.nTimes;
...
OPSTAT fsm_winddir_l3aqyc_exg_ctrl_req(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	return SUCCESS;
}

OPSTAT fsm_winddir_zhbl3mod_exg_ctrl_req(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	return SUCCESS;
}
