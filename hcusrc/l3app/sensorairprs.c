...
HcuFsmStateItem_t HcuFsmAirprs[] =
{
    ...
    //Task level initialization
	{MSG_ID_CLOUDVELA_AIRPRS_DATA_REQ,		FSM_STATE_AIRPRS_ACTIVED,      	  	fsm_airprs_cloudvela_data_req},
	{MSG_ID_CLOUDVELA_AIRPRS_DATA_CONFIRM,	FSM_STATE_AIRPRS_ACTIVED,      	  	fsm_airprs_cloudvela_data_confirm},
	{MSG_ID_L3AQYC_EXG_CTRL_REQ,			FSM_STATE_AIRPRS_ACTIVED,      	  	fsm_airprs_l3aqyc_exg_ctrl_req},
	{MSG_ID_ZHBL3MOD_EXG_CTRL_RESP,			FSM_STATE_AIRPRS_ACTIVED,      	  	fsm_airprs_zhbl3mod_exg_ctrl_req},
...
gTaskAirprsContext_t gTaskAirprsContext;
...
OPSTAT func_airprs_time_out_read_data_from_bmp180(void)
{
	...
	if ((zHcuVmCtrTab.codab.si[SENSOR_ID_I2CAIRPRSBMP180].fVal >= HCU_SENSOR_AIRPRS_VALUE_MIN) && (zHcuVmCtrTab.codab.si[SENSOR_ID_I2CAIRPRSBMP180].fVal <= HCU_SENSOR_AIRPRS_VALUE_MAX))
	{
		...
		airprsData.airprsValue = (int)(zHcuVmCtrTab.codab.si[SENSOR_ID_I2CAIRPRSBMP180].fVal*100);
	...
	if ((zHcuVmCtrTab.codab.si[SENSOR_ID_I2CALTITUDEBMP180].fVal >= HCU_SENSOR_ALTITUDE_VALUE_MIN) && (zHcuVmCtrTab.codab.si[SENSOR_ID_I2CALTITUDEBMP180].fVal <= HCU_SENSOR_ALTITUDE_VALUE_MAX))
	{
		...
		altitudeData.altitudeValue = (int)(zHcuVmCtrTab.codab.si[SENSOR_ID_I2CALTITUDEBMP180].fVal*100);
...
OPSTAT fsm_airprs_cloudvela_data_req(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	return SUCCESS;
}

//收到来自CLOUD和后台云的命令，从而重新配置本地控制信息
OPSTAT fsm_airprs_cloudvela_data_confirm(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	return SUCCESS;
}

OPSTAT fsm_airprs_l3aqyc_exg_ctrl_req(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	return SUCCESS;
}

OPSTAT fsm_airprs_zhbl3mod_exg_ctrl_req(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	return SUCCESS;
}
