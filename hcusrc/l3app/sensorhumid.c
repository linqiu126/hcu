...
OPSTAT func_humid_time_out_read_data_from_dht11(void)
{
	...
	//存入数据库
	if ((HCU_SYSCFG_SNR_DATA_SAVE_TO_LOCAL_DB_SET == HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES) && (zHcuGpioHumidDht11 >= HCU_SENSOR_HUMID_VALUE_MIN) && (zHcuGpioHumidDht11 <= HCU_SENSOR_HUMID_VALUE_MAX))
	{
...
OPSTAT func_humid_time_out_read_data_from_sht20(void)
{
	...
	//存入数据库
	if ((HCU_SYSCFG_SNR_DATA_SAVE_TO_LOCAL_DB_SET == HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES) && (zHcuI2cHumidSht20 >= HCU_SENSOR_HUMID_VALUE_MIN) && (zHcuI2cHumidSht20 <= HCU_SENSOR_HUMID_VALUE_MAX))
	{
...
OPSTAT func_humid_time_out_read_data_from_rht03(void)
{
	...
	//存入数据库
	if ((HCU_SYSCFG_SNR_DATA_SAVE_TO_LOCAL_DB_SET == HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES) && (zHcuSpiHumidRht03 >= HCU_SENSOR_HUMID_VALUE_MIN) && (zHcuSpiHumidRht03 <= HCU_SENSOR_HUMID_VALUE_MAX))
	{
...
OPSTAT func_humid_time_out_read_data_from_mth01(void)
{
	...
	//存入数据库
	if ((HCU_SYSCFG_SNR_DATA_SAVE_TO_LOCAL_DB_SET == HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES) && (zHcuSpiHumidMth01 >= HCU_SENSOR_HUMID_VALUE_MIN) && (zHcuSpiHumidMth01 <= HCU_SENSOR_HUMID_VALUE_MAX))
	{
