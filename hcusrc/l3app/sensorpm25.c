...
*/
	...
	if(rcv.pm25.pmTSPValue == 0 || rcv.pm25.pmTSPValue >= HCU_SENSOR_PM25_VALUE_ALARM_THRESHOLD*10000)
		gTaskPm25Context.TSP = 100;
	else
		gTaskPm25Context.TSP = (float)rcv.pm25.pmTSPValue;
	HCU_DEBUG_PRINT_INF("PM25: TSP = %.1f\n\n\n\n", gTaskPm25Context.TSP);


	HCU_DEBUG_PRINT_INF("PM25: PM25 = %d\n\n\n\n", (rcv.pm25.pm2d5Value));
	if(rcv.pm25.pm2d5Value == 0 || rcv.pm25.pm2d5Value >= HCU_SENSOR_PM25_VALUE_ALARM_THRESHOLD*10000)
		gTaskPm25Context.PM25Value = 100;
	else
