...
/home/pi/workspace/hcu/hcusrc/l2frame/bhcodecxml.c \
/home/pi/workspace/hcu/hcusrc/l2frame/bhcodeczhb.c \
...
src/l2frame/bhcodecxml.o: /home/pi/workspace/hcu/hcusrc/l2frame/bhcodecxml.c
	@echo 'Building file: $<'
	@echo 'Invoking: Cross GCC Compiler'
	gcc -DTARGET_RASPBERRY_PI3B -I/usr/include/libxml2 -I/usr/include/curl -I/usr/local/sqlite3/include -O0 -lpthread -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
...
src/l2frame/bhcodeczhb.o: /home/pi/workspace/hcu/hcusrc/l2frame/bhcodeczhb.c
	@echo 'Building file: $<'
	@echo 'Invoking: Cross GCC Compiler'
	gcc -DTARGET_RASPBERRY_PI3B -I/usr/include/libxml2 -I/usr/include/curl -I/usr/local/sqlite3/include -O0 -lpthread -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
