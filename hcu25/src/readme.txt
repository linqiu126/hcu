...
== Update log: 2015 Dec.6 SW Version: XQ.HCU.SW.R01.025 //ZJL
> Add libcurl in Eclipse Linux_ARM_A8 Build configuaratio. (make sure libcurl.so.4, and libcurl.so.4.4.0 are copied in /usr/lib in TARGET BOARD
> Test Curl/Xml lib run in Target 335xD target board
> Test USB 3G in 335xD board (add Init and Startup in system start, to be clean, only for test)
