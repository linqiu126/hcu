...
C_SRCS += \
/home/sourai/hcu/hcusrc/l0comvm/vm_config.c \
/home/sourai/hcu/hcusrc/l0comvm/vmlayer.c 
...
src/l0comvm/vm_config.o: /home/sourai/hcu/hcusrc/l0comvm/vm_config.c
	@echo 'Building file: $<'
...
src/l0comvm/vmlayer.o: /home/sourai/hcu/hcusrc/l0comvm/vmlayer.c
	@echo 'Building file: $<'
	@echo 'Invoking: Cross GCC Compiler'
	gcc -DTARGET_LINUX_X86 -I/usr/include/libxml2 -I/usr/include/curl -I/usr/local/sqlite3/include -O0 -lpthread -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
