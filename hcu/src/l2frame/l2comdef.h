...
{
	CLOUD_BH_MSG_TYPE_MIN = 0x00,
	CLOUD_BH_MSG_TYPE_DEVICE_REPORT_UINT8,
	CLOUD_BH_MSG_TYPE_DEVICE_CONTROL_UINT8,
	CLOUD_BH_MSG_TYPE_HEAT_BEAT_UINT8,
	CLOUD_BH_MSG_TYPE_MAX,
};
#define CLOUD_BH_MSG_TYPE_DEVICE_REPORT_STRING  "hcu_text"  //"hcu_text"
#define CLOUD_BH_MSG_TYPE_DEVICE_CONTROL_STRING  "hcu_command" //"hcu_command"
#define CLOUD_BH_MSG_TYPE_HEAT_BEAT_STRING "hcu_heart_beat"   //"hcu_heart_beat"  //心跳协议，里面的数据内容是空的
...
//中环保协议标准的格式定义
#define CLOUD_BH_ITF_STD_ZHB_DATA_SEGMENT_MAX_LENGTH 30
...
#define CLOUD_BH_ITF_STD_ZHB_CN_FIX_LENGTH 7
...
#define CLOUD_BH_ITF_STD_ZHB_CN_HEART_BEAT "ZHB_HRB"
#define CLOUD_BH_ITF_STD_ZHB_CN_NORMAL_PKG "ZHB_NOM"
