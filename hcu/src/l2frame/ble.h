...
#ifndef L2FRAME_BLE_H_
#define L2FRAME_BLE_H_
...
enum FSM_STATE_BLE
{
	FSM_STATE_BLE_INITED = 0x02,
	FSM_STATE_BLE_RECEIVED,  //所有人机命令在此状态下直接送达各个线程任务模块
	FSM_STATE_BLE_MAX,
};
