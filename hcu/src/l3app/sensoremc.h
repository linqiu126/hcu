...
#define EMC_TIMER_DURATION_PERIOD_READ 6 //should be 60 second, in second
...
extern OPSTAT fsm_emc_cloud_data_req(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);
void func_emc_time_out_read_data_from_modbus(void);
void func_emc_time_out_processing_no_rsponse(void);
extern OPSTAT fsm_emc_cloud_control_cmd(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len);
