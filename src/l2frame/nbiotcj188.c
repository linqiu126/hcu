...
FsmStateItem_t FsmNbiotcj188[] =
{
    ...
    //Task level initialization
    {MSG_ID_COM_RESTART,        FSM_STATE_NBIOTCJ188_ACTIVED,            	fsm_nbiotcj188_restart},
    {MSG_ID_COM_INIT_FEEDBACK,	FSM_STATE_NBIOTCJ188_ACTIVED,            	fsm_com_do_nothing},
	{MSG_ID_COM_HEART_BEAT,     FSM_STATE_NBIOTCJ188_ACTIVED,       		fsm_com_heart_beat_rcv},
	{MSG_ID_COM_HEART_BEAT_FB,  FSM_STATE_NBIOTCJ188_ACTIVED,       		fsm_com_do_nothing},
...
OPSTAT fsm_nbiotcj188_init(UINT32 dest_id, UINT32 src_id, void * param_ptr, UINT32 param_len)
{
	...
	//设置状态机到目标状态
	if (FsmSetState(TASK_ID_NBIOTCJ188, FSM_STATE_NBIOTCJ188_ACTIVED) == FAILURE){
