...
<<<<<<< HEAD
#define CURRENT_SW_DELIVERY 92 //001 = 0x01 (XQ.HCU.SW.R01.456), starting from 100 as 2015/11/02
=======
#define CURRENT_SW_DELIVERY 91 //001 = 0x01 (XQ.HCU.SW.R01.456), starting from 100 as 2015/11/02
