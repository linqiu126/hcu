...
//#ifdef HCU_CURRENT_WORKING_PROJECT_NAME_UNIQUE == HCU_WORKING_PROJECT_NAME_AQYC
...
/*
#elif HCU_CURRENT_WORKING_PROJECT_NAME_UNIQUE == HCU_WORKING_PROJECT_NAME_TBSWR
	#define COMM_HW_BOARD_ON 1
	#define COMM_HW_BOARD_OFF 0
	#define COMM_BACK_HAWL_CON 1 //0=NULL, 1=ETHERNET, 2=WIFI, 3=3G4G, 4=USBNET, 5/OTHERS=INVALID
	#define COMM_HW_BOARD_ETHERNET 1 //1=ON, 0/OTHERS=OFF
	...
	#define COMM_FRONT_SENSOR_TOXICGAS 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_PM25SHARP 1 //1=ON, 0/OTHERS=OFF
#elif HCU_CURRENT_WORKING_PROJECT_NAME_UNIQUE == HCU_WORKING_PROJECT_NAME_NBIOT_CJ188
	#define COMM_HW_BOARD_ON 1
	#define COMM_HW_BOARD_OFF 0
	#define COMM_BACK_HAWL_CON 1 //0=NULL, 1=ETHERNET, 2=WIFI, 3=3G4G, 4=USBNET, 5/OTHERS=INVALID
	#define COMM_HW_BOARD_ETHERNET 1 //1=ON, 0/OTHERS=OFF
	...
	#define COMM_FRONT_SENSOR_TOXICGAS 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_PM25SHARP 1 //1=ON, 0/OTHERS=OFF
#elif HCU_CURRENT_WORKING_PROJECT_NAME_UNIQUE == HCU_WORKING_PROJECT_NAME_NBIOT_QG376
	#define COMM_HW_BOARD_ON 1
	#define COMM_HW_BOARD_OFF 0
	#define COMM_BACK_HAWL_CON 1 //0=NULL, 1=ETHERNET, 2=WIFI, 3=3G4G, 4=USBNET, 5/OTHERS=INVALID
	#define COMM_HW_BOARD_ETHERNET 1 //1=ON, 0/OTHERS=OFF
	...
	#define COMM_FRONT_SENSOR_TOXICGAS 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_PM25SHARP 1 //1=ON, 0/OTHERS=OFF
#elif HCU_CURRENT_WORKING_PROJECT_NAME_UNIQUE == HCU_WORKING_PROJECT_NAME_TEST_MODE
	#define COMM_HW_BOARD_ON 1
	#define COMM_HW_BOARD_OFF 0
	#define COMM_BACK_HAWL_CON 1 //0=NULL, 1=ETHERNET, 2=WIFI, 3=3G4G, 4=USBNET, 5/OTHERS=INVALID
	#define COMM_HW_BOARD_ETHERNET 1 //1=ON, 0/OTHERS=OFF
