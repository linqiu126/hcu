...
//注意这里是互斥性定义，不要弄的重复了
#undef HCU_WORKING_PROJECT_NAME_AQYC "HCU_PRJ_AQYC"
#undef HCU_WORKING_PROJECT_NAME_TBSWR "HCU_PRJ_TBSWR"
#undef HCU_WORKING_PROJECT_NAME_NBIOT_CJ188 "HCU_PRJ_NBIOT_CJ188" //Intelligence Meter
#undef HCU_WORKING_PROJECT_NAME_NBIOT_QG376 "HCU_PRJ_NBIOT_QG376"
