...
//可选项通信端口的全局定义，未来需要通过ConfigXml进一步优化
	...
	#define COMM_HW_BOARD_LCD 0 //1=ON, 0/OTHERS=OFF
	#define COMM_HW_BOARD_LED 0 //1=ON, 0/OTHERS=OFF
	#define COMM_HW_BOARD_ZEEGBE 0 //1=ON, 0/OTHERS=OFF
	#define COMM_HW_BOARD_FLASH 0 //1=ON, 0/OTHERS=OFF  TF card
	...
	#define COMM_FRONT_I2CBUSLIBRA 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPIBUSARIES 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_NBIOTCJ188 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_NBIOTQG376 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPS485 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPS232 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_MICROPHONE 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_CAMERA 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_BLE 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_GPIO 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_I2C 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPI 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_PWM 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_ADC 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SWITCH 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_RELAY 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_MOTOR 0 //1=ON, 0/OTHERS=OFF
	...
	#define COMM_FRONT_SENSOR_AIRPRS 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_CO1 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_LIGHTSTR 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_ALCOHOL 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_HCHO 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_TOXICGAS 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_PM25SHARP 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_IWM 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_IHM 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_IGM 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_IPM 0 //1=ON, 0/OTHERS=OFF
#endif
	...
	#define COMM_FRONT_I2CBUSLIBRA 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPIBUSARIES 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_NBIOTCJ188 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_NBIOTQG376 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPS485 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPS232 1 //1=ON, 0/OTHERS=OFF
	...
	#define COMM_FRONT_SENSOR_TOXICGAS 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_PM25SHARP 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_IWM 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_IHM 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_IGM 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SENSOR_IPM 1 //1=ON, 0/OTHERS=OFF
#endif
	...
	#define COMM_FRONT_SPIBUSARIES 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_NBIOTCJ188 0 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_NBIOTQG376 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPS485 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_SPS232 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_MICROPHONE 1 //1=ON, 0/OTHERS=OFF
	#define COMM_FRONT_CAMERA 1 //1=ON, 0/OTHERS=OFF
...
#define IWM_TIMER_DURATION_PERIOD_READ 600
#define IHM_TIMER_DURATION_PERIOD_READ 600
#define IGM_TIMER_DURATION_PERIOD_READ 600
#define IPM_TIMER_DURATION_PERIOD_READ 600
