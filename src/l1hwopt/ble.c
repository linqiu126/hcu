...
FsmStateItem_t FsmBle[] =
{
    ...
    {MSG_ID_COM_INIT_FEEDBACK,	FSM_STATE_BLE_RECEIVED,            		fsm_com_do_nothing},
	{MSG_ID_COM_HEART_BEAT,     FSM_STATE_BLE_RECEIVED,       			fsm_com_heart_beat_rcv},
	{MSG_ID_COM_HEART_BEAT_FB,  FSM_STATE_BLE_RECEIVED,       			fsm_com_do_nothing},
