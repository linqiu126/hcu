...
class Hcusysengpar extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['cloudhttpaddlocal', 'cloudhttpaddtest', 'cloudhttpaddsae', 'cloudhttpaddjd', 'cloudhttpaddwechat', 'cloudftpadd', 'hcuswdownloaddir', 'hcuvideoserverdir', 'hcuvideoserverhttp'], 'string', 'max' => 64],
