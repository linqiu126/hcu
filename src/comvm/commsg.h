...
enum HCU_INTER_TASK_MSG_ID
{
	...
	MSG_ID_CLOUD_WIND_DIR_DATA_REQ,
	MSG_ID_CLOUD_WIND_SPEED_DATA_REQ,
	MSG_ID_CLOUD_TEMPERATURE_DATA_REQ,
	MSG_ID_CLOUD_HUMIDITY_DATA_REQ,
