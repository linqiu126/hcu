...
HcuFsmStateItem_t FsmToxicgas[] =
{
    ...
    {MSG_ID_COM_RESTART,		FSM_STATE_IDLE,            				fsm_toxicgas_restart},
    {MSG_ID_COM_INIT_FEEDBACK,	FSM_STATE_IDLE,            				fsm_com_do_nothing},

	//Task level initialization
    {MSG_ID_COM_INIT,       	FSM_STATE_TOXICGAS_INITIED,            	fsm_toxicgas_init},
    {MSG_ID_COM_RESTART,		FSM_STATE_TOXICGAS_INITIED,            	fsm_toxicgas_restart},
    {MSG_ID_COM_INIT_FEEDBACK,	FSM_STATE_TOXICGAS_INITIED,            	fsm_com_do_nothing},

    //Task level initialization
    {MSG_ID_COM_RESTART,        FSM_STATE_TOXICGAS_ACTIVED,            	fsm_toxicgas_restart},
	...
	{MSG_ID_COM_TIME_OUT,       FSM_STATE_TOXICGAS_ACTIVED,          	fsm_toxicgas_time_out},
...
OPSTAT func_toxicgas_time_out_read_data_from_mq135(void)
{
	...
	//存入数据库
	if ((HCU_SENSOR_DATA_SAVE_TO_LOCAL_DB_SET == HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES) && (zHcuGpioToxicgasMq135 >= HCU_SENSOR_TOXICGAS_VALUE_MIN) && (zHcuGpioToxicgasMq135 <= HCU_SENSOR_TOXICGAS_VALUE_MAX))
	{
...
OPSTAT func_toxicgas_time_out_read_data_from_zp01voc(void)
{
	...
	//存入数据库
	if ((HCU_SENSOR_DATA_SAVE_TO_LOCAL_DB_SET == HCU_SYSCFG_SENSOR_SAVE_TO_LOCAL_DB_FLAG_YES) && (zHcuGpioToxicgasZp01voc >= HCU_SENSOR_TOXICGAS_VALUE_MIN) && (zHcuGpioToxicgasZp01voc <= HCU_SENSOR_TOXICGAS_VALUE_MAX))
	{
