...
C_SRCS += \
/home/sourai/hcu/hcusrc/l1hwopt/usb_adc/usb-daq-v20.c \
/home/sourai/hcu/hcusrc/l1hwopt/usb_adc/usb_daq_test.c 
...
src/l1hwopt/usb_adc/usb-daq-v20.o: /home/sourai/hcu/hcusrc/l1hwopt/usb_adc/usb-daq-v20.c
	@echo 'Building file: $<'
...
src/l1hwopt/usb_adc/usb_daq_test.o: /home/sourai/hcu/hcusrc/l1hwopt/usb_adc/usb_daq_test.c
	@echo 'Building file: $<'
	@echo 'Invoking: Cross GCC Compiler'
	gcc -DTARGET_RASPBERRY_PI3B -I/usr/include/libxml2 -I/usr/include/curl -I/usr/local/sqlite3/include -O0 -lpthread -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
