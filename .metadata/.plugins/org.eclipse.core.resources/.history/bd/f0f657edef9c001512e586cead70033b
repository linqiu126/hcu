...
SerialPort_t gSerialPort = {COM_PORT_3, 9600, 8, 'N', 1, HCU_INVALID_U16, 0, 1, 0};//initial config date for serial port
...
OPSTAT func_modbus_pm25_msg_pack(msg_struct_pm25_modbus_data_read_t *inMsg, SerialModbusMsgBuf_t *outMsg)
{
	...
	case L3PO_pm25_set_pm1025_switch:
		break;
